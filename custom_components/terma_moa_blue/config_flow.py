...
class TermaMoaBlueConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
...
>>>>>>> db12798 (v1.0.1 - Fix HACS structure and add debug logging)
            if (
...
<<<<<<< HEAD
            if discovery_info.name and "MOA Blue" in discovery_info.name:
=======
